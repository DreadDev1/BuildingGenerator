...
#include "RoomGenerationTypes.generated.h"
...
struct FPlacedMeshInfo
{
	...
	FPlacedMeshInfo() : GridPosition(FIntPoint:: ZeroValue), GridFootprint(FIntPoint::ZeroValue), Rotation(0) {}
};
