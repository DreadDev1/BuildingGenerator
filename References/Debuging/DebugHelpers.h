...
UENUM(BlueprintType)
enum class EDebugHelpersLogLevel : uint8
{
...
class BUILDINGGENERATOR_API UDebugHelpers : public UActorComponent
{
	GENERATED_BODY()
...
#pragma region Logging Settings
	...
	EDebugHelpersLogLevel CurrentLogLevel = EDebugHelpersLogLevel::Important;
...
#pragma region Internal Helpers
	...
	bool ShouldLog(EDebugHelpersLogLevel MessageLevel) const;
#pragma endregion
};