...
bool UDebugHelpers::ShouldLog(EDebugHelpersLogLevel MessageLevel) const
{
...
{
	if (! ShouldLog(EDebugHelpersLogLevel::Important)) return;
...
{
	if (!ShouldLog(EDebugHelpersLogLevel::Verbose)) return;
